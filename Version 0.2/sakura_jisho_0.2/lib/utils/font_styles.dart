...
class CustomTextStyle {
  ...
  static TextStyle show(BuildContext context) {
    return Theme.of(context).textTheme.display4.copyWith(
        color: Colors.white, fontSize: 16.0, fontWeight: FontWeight.w600);
  }

  static TextStyle hide(BuildContext context) {
    return Theme.of(context).textTheme.display4.copyWith(
        color: Colors.white30, fontSize: 16.0, fontWeight: FontWeight.w600);
  }
  ...
  static TextStyle traillingListTile(BuildContext context) {
    return Theme.of(context).textTheme.display4.copyWith(
        color: Colors.white70, fontSize: 14.0, fontWeight: FontWeight.w300);
  }
